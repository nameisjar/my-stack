...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'main.ts'), content);
  }

  private async generateAppVue(): Promise<void> {
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'App.vue'), content);
  }

  private async generateRouter(): Promise<void> {
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'router', 'index.ts'), content);
  }
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'pages', 'HomePage.vue'), homePage);
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'pages', 'AboutPage.vue'), aboutPage);
...
` : ''}`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'pages', 'NotFoundPage.vue'), notFoundPage);
  }
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'components', 'BaseCard.vue'), content);
  }
...
`;
  ...
  private async generateStores(): Promise<void> {
    if (this.config.frontend.stateManagement === 'pinia') {
...
`;
      ...
      await writeFile(path.join(this.frontendPath, 'src', 'stores', 'index.ts'), content);
    } else {
...
export {};
`;
      await writeFile(path.join(this.frontendPath, 'src', 'stores', 'index.ts'), placeholderContent);
    }
  }
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'assets', 'main.css'), content);
  }
...
`;
  ...
  private async generateComposables(): Promise<void> {
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'composables', 'useDebounce.ts'), useDebounce);
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'composables', 'useLocalStorage.ts'), useLocalStorage);
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'composables', 'useFetch.ts'), useFetch);
...
`;
    ...
    await writeFile(path.join(this.frontendPath, 'src', 'composables', 'index.ts'), index);
  }
