...
class DockerGenerator extends base_js_1.BaseGenerator {
    name = 'Docker';
    async generate() {
        if (!this.config.docker)
            return;
        await (0, index_js_1.ensureDir)(path_1.default.join(this.config.rootPath, 'docker'));
        await Promise.all([
    ...
    async generateBackendDockerfile() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.config.rootPath, 'docker', 'Dockerfile.backend'), content);
    }
    async generateFrontendDockerfile() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.config.rootPath, 'docker', 'Dockerfile.frontend'), content);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.config.rootPath, 'docker-compose.yml'), content);
...
` : ''}
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.config.rootPath, 'docker-compose.dev.yml'), content);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.config.rootPath, 'docker', 'nginx.conf'), content);
...
`;
            await (0, index_js_1.writeFile)(path_1.default.join(this.config.rootPath, 'docker', 'nginx.frontend.conf'), frontendNginx);
        }
    }
...
Dockerfile*
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.config.rootPath, '.dockerignore'), content);
        // Also create in backend/frontend folders
        if (this.config.structure === 'monorepo') {
            await (0, index_js_1.writeFile)(path_1.default.join(this.config.backendPath, '.dockerignore'), content);
            if (this.config.frontend.framework !== 'none') {
                await (0, index_js_1.writeFile)(path_1.default.join(this.config.frontendPath, '.dockerignore'), content);
            }
        }
    }
}
