...
class ExpressGenerator extends base_js_1.BaseGenerator {
    name = 'Express.js';
    async generate() {
...
module.exports = router;
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'routes', `index.${this.ext}`), indexRoute);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'controllers', `health.${this.ext}`), healthController);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'middlewares', `error.${this.ext}`), errorMiddleware);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'config', `index.${this.ext}`), configContent);
    }
...
`;
        ...
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, '.env.example'), envContent);
    }
    async generateEslintConfig() {
        ...
        await (0, index_js_1.writeJsonFile)(path_1.default.join(this.backendPath, '.eslintrc.json'), eslintConfig);
    }
    async generatePrettierConfig() {
        ...
        await (0, index_js_1.writeJsonFile)(path_1.default.join(this.backendPath, '.prettierrc'), prettierConfig);
    }
}
