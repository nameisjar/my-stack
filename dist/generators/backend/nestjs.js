...
class NestJSGenerator extends base_js_1.BaseGenerator {
    name = 'NestJS';
    ...
    async generateTsConfig() {
        ...
        await (0, index_js_1.writeJsonFile)(path_1.default.join(this.backendPath, 'tsconfig.build.json'), tsBuild);
    }
    async generateNestCliConfig() {
        const config = {
        ...
        await (0, index_js_1.writeJsonFile)(path_1.default.join(this.backendPath, 'nest-cli.json'), config);
    }
    async generateMain() {
...
bootstrap();
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'main.ts'), content);
    }
    async generateAppModule() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'app.module.ts'), content);
    }
    async generateAppController() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'app.controller.ts'), content);
    }
    async generateAppService() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'app.service.ts'), content);
    }
    async generateHealthModule() {
        // Health Module
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'health', 'health.controller.ts'), controller);
    }
    async generateConfigModule() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'config', 'configuration.ts'), content);
    }
    async generateCommonFiles() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'common', 'filters', 'http-exception.filter.ts'), exceptionFilter);
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'common', 'interceptors', 'transform.interceptor.ts'), transformInterceptor);
    }
