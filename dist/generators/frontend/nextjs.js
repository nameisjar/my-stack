...
class NextJSGenerator extends base_js_1.BaseGenerator {
    name = 'Next.js';
    async generate() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'next.config.mjs'), content);
        if (this.config.frontend.styling === 'tailwind') {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'app', 'layout.tsx'), layout);
        // Providers (for Redux)
        if (hasRedux) {
...
`;
            await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'app', 'providers.tsx'), providers);
        }
    }
    async generatePages() {
        const hasTailwind = this.config.frontend.styling === 'tailwind';
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'app', 'page.tsx'), homePage);
        // About page
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'app', 'about', 'page.tsx'), aboutPage);
        // Not found page
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'app', 'not-found.tsx'), notFoundPage);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'components', 'Card.tsx'), content);
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'components', 'index.ts'), "export * from './Card';\n");
    }
...
`;
            await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'store', 'counterSlice.ts'), counterSlice);
...
`;
            await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'store', 'userSlice.ts'), userSlice);
...
`;
            await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'store', 'hooks.ts'), hooks);
        }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'app', 'globals.css'), content);
    }
...
`;
        ...
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, '.env.local.example'), content);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'next-env.d.ts'), content);
    }
    async generateHooks() {
        // useDebounce hook
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'public', 'favicon.svg'), favicon);
        // Also create icon.svg for Next.js app router
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'app', 'icon.svg'), favicon);
    }
}
