...
class ReactGenerator extends base_js_1.BaseGenerator {
    name = 'React';
    async generate() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'main.tsx'), content);
    }
    async generateApp() {
...
export default App;
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'App.tsx'), content);
    }
    async generatePages() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'pages', 'HomePage.tsx'), homePage);
        // About Page
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'pages', 'AboutPage.tsx'), aboutPage);
        // 404 Page
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'pages', 'NotFoundPage.tsx'), notFoundPage);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.frontendPath, 'src', 'assets', 'index.css'), content);
    }
