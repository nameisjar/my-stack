...
exports.MailingGenerator = void 0;
const path_1 = __importDefault(require("path"));
const base_js_1 = require("./base.js");
const index_js_1 = require("../utils/index.js");
class MailingGenerator extends base_js_1.BaseGenerator {
    name = 'Mailing';
    async generate() {
        const mailingProvider = this.config.backend.mailing;
        if (mailingProvider === 'none')
            return;
        // Create mailing directories
        await (0, index_js_1.ensureDir)(path_1.default.join(this.backendPath, 'src', 'lib'));
        await (0, index_js_1.ensureDir)(path_1.default.join(this.backendPath, 'src', 'emails'));
        await Promise.all([
...
`;
        ...
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'lib', `mail.${this.ext}`), content);
    }
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'emails', `welcome.${this.ext}x`), welcomeTemplate);
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'emails', `reset-password.${this.ext}x`), resetTemplate);
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'emails', `index.${this.ext}`), indexContent);
    }
    async generateEmailService() {
...
`;
        await (0, index_js_1.writeFile)(path_1.default.join(this.backendPath, 'src', 'lib', `email-service.${this.ext}`), content);
    }
...
exports.MailingGenerator = MailingGenerator;
